...
export default function ChapterNotes() {
  ...
  if (!chapter.notesUrl) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">Notes Not Available</h1>
          <p className="text-gray-600 mb-6">Notes for this chapter have not been uploaded yet.</p>
          <Link href="/" className="text-blue-600 hover:text-blue-800 underline">
            Return to Home
          </Link>
        </div>
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow">
        ...
        <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
          ...
          >
            <p>Your browser doesn't support PDFs. <a href={chapter.notesUrl} target="_blank" rel="noopener noreferrer">Download the notes</a></p>
          </iframe>
        </div>
      </div>
    </div>
