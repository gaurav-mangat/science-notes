...
const AdBanner = ({ position, className = "" }) => (
  <div className={`bg-gradient-to-r from-yellow-400 to-orange-500 rounded-lg p-4 text-center ${className}`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#recent" className="hover:text-blue-200 transition">Resources</a>
              <a href="#about" className="hover:text-blue-200 transition">About</a>
              <a href="/admin/upload-simple" className="hover:text-blue-200 transition">Admin</a>
            </div>
        ...
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Unlock Your <span className="text-blue-600">Learning Potential</span>
            </h1>
            ...
            <div className="max-w-md mx-auto relative">
              <input
                ...
                className="w-full px-5 py-3 rounded-full border-0 shadow-md focus:ring-2 focus:ring-blue-500"
              />
        ...
        {activeView !== 'class-select' && (
          <nav className="flex mb-8" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-2">
              <li>
                <button onClick={resetNavigation} className="text-blue-600 hover:text-blue-800">
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex items-center">
                                <div className="flex-shrink-0 h-10 w-10 rounded-full bg-blue-100 flex items-center justify-center">
                                  <span className="text-blue-600 font-medium">{chapter.chapterNumber || id}</span>
                                </div>
                                <div className="ml-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">Empowering students with quality education resources since 2023.</p>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-white">Practice Tests</a></li>
              </ul>
            </div>
            <div>
